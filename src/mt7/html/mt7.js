...
(function($opal) {
  ...
  $opal.add_stubs(['$size', '$stat', '$open', '$close', '$[]', '$send', '$unpack', '$read', '$seek', '$+', '$*', '$collect', '$times', '$==', '$!', '$include?', '$<<', '$delete_if', '$>', '$tell', '$&', '$>>', '$-', '$/', '$extract_faces', '$extract_floats', '$merge', '$get_positions', '$each', '$parse_xb01', '$get_xb01s', '$each_with_index', '$operation', '$new', '$each_object', '$o', '$v', '$p', '$x', '$vt', '$n', '$with_index', '$usemtl', '$f', '$to_a', '$each_slice', '$each_texture_with_index', '$material', '$instance_eval', '$to_proc', '$puts', '$join', '$instance_of?', '$to_s']);
  ;
  (function($base, $super) {
    function $MT7(){};
    var self = $MT7 = $klass($base, $super, 'MT7', $MT7);

    var def = self._proto, $scope = self._scope, TMP_1, TMP_16, TMP_18, TMP_24;

    def.f = def.file_size = def.texture_start = nil;
    def.$initialize = TMP_1 = function(path) {
      var $a, self = this, $iter = TMP_1._p, $yield = $iter || nil;

      TMP_1._p = null;
      self.file_size = (($a = $scope.File) == null ? $opal.cm('File') : $a).$stat(path).$size();
      self.f = (($a = $scope.File) == null ? $opal.cm('File') : $a).$open(path, "rb");
      if ($opal.$yield1($yield, self) === $breaker) return $breaker.$v;
      return self.f.$close();
    };

    def.$read = function(what) {
      var $a, self = this, type = nil, size = nil, convert = nil;

      $a = $opal.to_ary($hash2(["unsigned_integer", "unsigned_short", "float"], {"unsigned_integer": ["I", 4, "to_i"], "unsigned_short": ["S", 2, "to_i"], "float": ["f", 4, "to_f"]})['$[]'](what)), type = ($a[0] == null ? nil : $a[0]), size = ($a[1] == null ? nil : $a[1]), convert = ($a[2] == null ? nil : $a[2]);
      return self.f.$read(size).$unpack(type)['$[]'](0).$send(convert);
    };

    def.$get_positions = function() {
      var $a, $b, TMP_2, self = this, first_position = nil, offset = nil, count = nil;

      first_position = self.$read("unsigned_integer");
      offset = self.$read("unsigned_integer");
      self.f.$seek((16)['$+']((24)['$*'](offset)));
      count = self.$read("unsigned_short");
      self.$read("unsigned_short");
      return [first_position]['$+'](($a = ($b = count.$times()).$collect, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

      return self.$read("unsigned_integer")}, TMP_2._s = self, TMP_2), $a).call($b));
    };

    def.$get_xb01s = function(positions) {
      var $a, $b, TMP_3, $c, $d, TMP_7, self = this;

      return ($a = ($b = ($c = ($d = positions).$delete_if, $c._p = (TMP_7 = function(x){var self = TMP_7._s || this;
if (x == null) x = nil;
      return x['$=='](0)}, TMP_7._s = self, TMP_7), $c).call($d)).$collect, $a._p = (TMP_3 = function(position){var self = TMP_3._s || this, $a, $b, TMP_4, $c, TMP_5, $d, TMP_6, $e, res = nil, next_position = nil;
        if (self.f == null) self.f = nil;
if (position == null) position = nil;
      self.f.$seek(position);
        self.$read("unsigned_integer");
        res = $hash2(["position", "rotation", "scale", "xb01"], {"position": ($a = ($b = (3).$times()).$collect, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;

        return self.$read("float")}, TMP_4._s = self, TMP_4), $a).call($b), "rotation": ($a = ($c = (3).$times()).$collect, $a._p = (TMP_5 = function(){var self = TMP_5._s || this;

        return self.$read("unsigned_integer")}, TMP_5._s = self, TMP_5), $a).call($c), "scale": ($a = ($d = (3).$times()).$collect, $a._p = (TMP_6 = function(){var self = TMP_6._s || this;

        return self.$read("float")}, TMP_6._s = self, TMP_6), $a).call($d), "xb01": self.$read("unsigned_integer")});
        next_position = 0;
        while (next_position['$=='](0)) {
        next_position = self.$read("unsigned_integer")};
        if ((($a = ($e = next_position['$=='](0)['$!'](), $e !== false && $e !== nil ?positions['$include?'](next_position)['$!']() : $e)) !== nil && (!$a._isBoolean || $a == true))) {
          positions['$<<'](next_position)};
        return res;}, TMP_3._s = self, TMP_3), $a).call($b);
    };

    def.$extract_faces = function(floats_start) {
      var $a, $b, $c, TMP_8, $d, TMP_9, self = this, faces = nil, textures = nil, counter = nil, type = nil, next_count = nil, delta = nil, _next = nil, current = nil, size = nil;

      self.f.$read((6)['$*'](4));
      faces = [];
      textures = [];
      while ((($b = true) !== nil && (!$b._isBoolean || $b == true))) {
      if (self.f.$tell()['$>'](floats_start)) {
        break;};
      counter = self.$read("unsigned_integer");
      type = counter['$&'](255);
      next_count = counter['$>>'](8);
      delta = (4)['$*']((next_count['$-'](1)));
      _next = self.f.$tell()['$+'](delta);
      if (type['$=='](0)) {
        current = self.f.$read((5)['$*'](4))
      } else if (type['$=='](16)) {
        self.$read("unsigned_integer");
        size = self.$read("unsigned_integer");
        faces['$<<']((($b = ($c = size.$times()).$collect, $b._p = (TMP_8 = function(){var self = TMP_8._s || this;

        return self.$read("unsigned_short")}, TMP_8._s = self, TMP_8), $b).call($c)));
        self.f.$seek(_next);
      } else if (type['$=='](4)) {
        ($b = ($d = (next_count['$-'](1))).$times, $b._p = (TMP_9 = function(){var self = TMP_9._s || this;

        return self.$read("float")}, TMP_9._s = self, TMP_9), $b).call($d)
      } else if (type['$=='](11)) {
        self.$read("unsigned_integer");
        textures['$<<'](self.$read("unsigned_integer"));
        self.f.$read(delta['$-'](8));
        } else {
        self.f.$read(delta)
      };};
    ...
    def.$extract_floats = function(floats_start) {
      var $a, $b, TMP_10, self = this, n = nil, vertices = nil, normals = nil, texture_coordinates = nil;

      self.f.$seek(floats_start);
      n = (self.$read("unsigned_integer")['$>>'](8))['$-'](4);
      self.f.$read((3)['$*'](4));
      vertices = [];
      normals = [];
      texture_coordinates = [];
      ($a = ($b = (n['$/'](8))).$times, $a._p = (TMP_10 = function(){var self = TMP_10._s || this, $a, $b, TMP_11, $c, TMP_12, $d, TMP_13;

      vertices['$<<'](($a = ($b = (3).$times()).$collect, $a._p = (TMP_11 = function(){var self = TMP_11._s || this;

        return self.$read("float")}, TMP_11._s = self, TMP_11), $a).call($b));
        normals['$<<'](($a = ($c = (3).$times()).$collect, $a._p = (TMP_12 = function(){var self = TMP_12._s || this;

        return self.$read("float")}, TMP_12._s = self, TMP_12), $a).call($c));
        return texture_coordinates['$<<'](($a = ($d = (2).$times()).$collect, $a._p = (TMP_13 = function(){var self = TMP_13._s || this;

        return self.$read("float")}, TMP_13._s = self, TMP_13), $a).call($d));}, TMP_10._s = self, TMP_10), $a).call($b);
      return [vertices, normals, texture_coordinates];
    };

    def.$parse_xb01 = function(xb01) {
      var $a, $b, TMP_14, self = this, floats_start = nil, faces = nil, textures = nil, vertices = nil, normals = nil, texture_coordinates = nil;

      self.f.$seek(xb01['$[]']("xb01"));
      if ((xb01['$[]']("xb01")['$+']((7)['$*'](4)))['$>'](self.file_size)) {
        return nil};
      self.$read("unsigned_integer");
      ($a = ($b = (6)).$times, $a._p = (TMP_14 = function(){var self = TMP_14._s || this;

      return self.$read("float")}, TMP_14._s = self, TMP_14), $a).call($b);
      floats_start = self.f.$tell()['$+'](self.$read("unsigned_integer")['$*'](4));
      self.f.$read(20);
      $a = $opal.to_ary(self.$extract_faces(floats_start)), faces = ($a[0] == null ? nil : $a[0]), textures = ($a[1] == null ? nil : $a[1]);
      $a = $opal.to_ary(self.$extract_floats(floats_start)), vertices = ($a[0] == null ? nil : $a[0]), normals = ($a[1] == null ? nil : $a[1]), texture_coordinates = ($a[2] == null ? nil : $a[2]);
      return $hash2(["faces", "textures", "vertices", "normals", "texture_coordinates"], {"faces": faces, "textures": textures, "vertices": vertices, "normals": normals, "texture_coordinates": texture_coordinates}).$merge(xb01);
    };

    def.$each_object = TMP_16 = function() {
      var $a, $b, TMP_15, self = this, $iter = TMP_16._p, $yield = $iter || nil, positions = nil;

      TMP_16._p = null;
      self.$read("unsigned_integer");
      self.texture_start = self.$read("unsigned_integer");
      positions = self.$get_positions();
      return ($a = ($b = self.$get_xb01s(positions)).$each, $a._p = (TMP_15 = function(xb01){var self = TMP_15._s || this, $a;
if (xb01 == null) xb01 = nil;
      return $a = $opal.$yield1($yield, self.$parse_xb01(xb01)), $a === $breaker ? $a : $a}, TMP_15._s = self, TMP_15), $a).call($b);
    };

    def.$operation = TMP_18 = function(a, b) {
      var $a, $b, TMP_17, self = this, $iter = TMP_18._p, $yield = $iter || nil, res = nil;

      TMP_18._p = null;
      res = [];
      ($a = ($b = a).$each_with_index, $a._p = (TMP_17 = function(item, i){var self = TMP_17._s || this, $a;
if (item == null) item = nil;if (i == null) i = nil;
      return res['$<<'](((($a = $opal.$yieldX($yield, [item, b['$[]'](i)])) === $breaker) ? $breaker.$v : $a))}, TMP_17._s = self, TMP_17), $a).call($b);
      return res;
    };
    ...
    def.$p = function(a, b) {
      ...
      return ($a = ($b = self).$operation, $a._p = (TMP_19 = function(x, y){var self = TMP_19._s || this;
if (x == null) x = nil;if (y == null) y = nil;
      return x['$+'](y)}, TMP_19._s = self, TMP_19), $a).call($b, a, b);
    };

    def.$x = function(a, b) {
      var $a, $b, TMP_20, self = this;

      return ($a = ($b = self).$operation, $a._p = (TMP_20 = function(x, y){var self = TMP_20._s || this;
if (x == null) x = nil;if (y == null) y = nil;
      return x['$*'](y)}, TMP_20._s = self, TMP_20), $a).call($b, a, b);
    };

    def.$each_texture_with_index = TMP_24 = function() {
      var $a, $b, $c, TMP_21, TMP_22, $d, TMP_23, self = this, $iter = TMP_24._p, $yield = $iter || nil, a = nil, b = nil, count = nil, texture_addresses = nil;

      TMP_24._p = null;
      self.f.$seek(self.texture_start);
      $a = $opal.to_ary(($b = ($c = (3).$times().$each()).$collect, $b._p = (TMP_21 = function(){var self = TMP_21._s || this;

      return self.$read("unsigned_integer")}, TMP_21._s = self, TMP_21), $b).call($c)), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]), count = ($a[2] == null ? nil : $a[2]);
      texture_addresses = ($a = ($b = count.$times().$each()).$collect, $a._p = (TMP_22 = function(){var self = TMP_22._s || this;

      return self.$read("unsigned_integer")}, TMP_22._s = self, TMP_22), $a).call($b);
      return ($a = ($d = texture_addresses).$each_with_index, $a._p = (TMP_23 = function(texture_address, i){var self = TMP_23._s || this, $a;
        if (self.f == null) self.f = nil;
if (texture_address == null) texture_address = nil;if (i == null) i = nil;
      self.f.$seek(texture_address);
        self.f.$read(16);
        return $a = $opal.$yieldX($yield, [self.f.$read((28)['$+'](self.$read("unsigned_integer"))), i]), $a === $breaker ? $a : $a;}, TMP_23._s = self, TMP_23), $a).call($d);
    };

    return (def.$to_obj = function() {
      var $a, $b, TMP_25, $c, TMP_32, $d, $e, self = this, i = nil, delta = nil, mt7 = nil, texture_max = nil, obj = nil, pngs = nil, mtl = nil;

      i = 0;
      delta = 1;
      mt7 = self;
      texture_max = 0;
      obj = ($a = ($b = (($c = $scope.Wavefront) == null ? $opal.cm('Wavefront') : $c)).$new, $a._p = (TMP_25 = function(){var self = TMP_25._s || this, $a, $b, TMP_26;

      ($a = ($b = mt7).$each_object, $a._p = (TMP_26 = function(object){var self = TMP_26._s || this, $a, $b, TMP_27, $c, TMP_28, $d, TMP_29, $e, TMP_30;
if (object == null) object = nil;
        self.$o("object_" + (i));
          ($a = ($b = object['$[]']("vertices")).$each, $a._p = (TMP_27 = function(vertex){var self = TMP_27._s || this;
if (vertex == null) vertex = nil;
          return self.$v(mt7.$p(mt7.$x(vertex, object['$[]']("scale")), object['$[]']("position")))}, TMP_27._s = self, TMP_27), $a).call($b);
          ($a = ($c = object['$[]']("texture_coordinates")).$each, $a._p = (TMP_28 = function(coords){var self = TMP_28._s || this;
if (coords == null) coords = nil;
          return self.$vt(coords)}, TMP_28._s = self, TMP_28), $a).call($c);
          ($a = ($d = object['$[]']("normals")).$each, $a._p = (TMP_29 = function(normal){var self = TMP_29._s || this;
if (normal == null) normal = nil;
          return self.$n(normal)}, TMP_29._s = self, TMP_29), $a).call($d);
          ($a = ($e = object['$[]']("faces").$each()).$with_index, $a._p = (TMP_30 = function(face, t){var self = TMP_30._s || this, $a, $b, TMP_31;
if (face == null) face = nil;if (t == null) t = nil;
          self.$usemtl("material_" + (object['$[]']("textures")['$[]'](t)));
            if (t['$>'](texture_max)) {
              texture_max = t};
            return ($a = ($b = face.$each_slice(3).$to_a()).$each, $a._p = (TMP_31 = function(a){var self = TMP_31._s || this;
if (a == null) a = nil;
            return self.$f(a, delta)}, TMP_31._s = self, TMP_31), $a).call($b);}, TMP_30._s = self, TMP_30), $a).call($e);
          return delta = delta['$+'](object['$[]']("vertices").$size());}, TMP_26._s = self, TMP_26), $a).call($b);
        return i = i['$+'](1);}, TMP_25._s = self, TMP_25), $a).call($b);
      pngs = [];
      mtl = ($a = ($c = (($d = ((($e = $scope.Wavefront) == null ? $opal.cm('Wavefront') : $e))._scope).Material == null ? $d.cm('Material') : $d.Material)).$new, $a._p = (TMP_32 = function(){var self = TMP_32._s || this, $a, $b, TMP_33;

      return ($a = ($b = mt7).$each_texture_with_index, $a._p = (TMP_33 = function(data, i){var self = TMP_33._s || this, $a, png_name = nil;
if (data == null) data = nil;if (i == null) i = nil;
        png_name = "name_" + (i) + ".png";
          pngs['$<<']((($a = $scope.Pvrx2png) == null ? $opal.cm('Pvrx2png') : $a).$new(data, png_name));
          return self.$material("material_" + (i), png_name);}, TMP_33._s = self, TMP_33), $a).call($b)}, TMP_32._s = self, TMP_32), $a).call($c);
      return [obj, mtl, pngs];
    }, nil) && 'to_obj';
  })(self, null);
  (function($base, $super) {
    function $Pvrx2png(){};
    var self = $Pvrx2png = $klass($base, $super, 'Pvrx2png', $Pvrx2png);

    var def = self._proto, $scope = self._scope;

    return (def.$initialize = function(data, name) {
      var self = this;

      self.name = name;
      self.data = data;
      return self.png =  pvrx2png(data, name) ;
    }, nil) && 'initialize'
  })(self, null);
  return (function($base, $super) {
    function $Wavefront(){};
    var self = $Wavefront = $klass($base, $super, 'Wavefront', $Wavefront);

    var def = self._proto, $scope = self._scope, TMP_37, TMP_40;
    ...
    (function($base, $super) {
      function $Material(){};
      var self = $Material = $klass($base, $super, 'Material', $Material);

      var def = self._proto, $scope = self._scope, TMP_34;

      def.contents = nil;
      def.$material = function(name, image) {
        var self = this;

        return self.contents = self.contents['$+'](["newmtl name", "Ns 96.078431", "Ka 0.000000 0.000000 0.000000", "Kd 0.640000 0.640000 0.640000", "Ks 0.500000 0.500000 0.500000", "Ni 1.000000", "d 1.000000", "illum 2", "map_Kd " + (image), "map_d " + (image)]);
      };

      return (def.$initialize = TMP_34 = function() {
        var $a, $b, self = this, $iter = TMP_34._p, block = $iter || nil;
    ...
    def.$f = function(items, delta) {
      var $a, $b, TMP_35, $c, $d, TMP_36, self = this;

      return self.$puts("f " + (($a = ($b = ($c = ($d = items).$collect, $c._p = (TMP_36 = function(x){var self = TMP_36._s || this;
if (x == null) x = nil;
      return x['$+'](delta)}, TMP_36._s = self, TMP_36), $c).call($d)).$collect, $a._p = (TMP_35 = function(x){var self = TMP_35._s || this;
if (x == null) x = nil;
      return "" + (x) + "/" + (x) + "/" + (x)}, TMP_35._s = self, TMP_35), $a).call($b).$join(" ")));
    };

    def.$method_missing = TMP_37 = function(name, args) {
      var $a, $b, TMP_38, self = this, $iter = TMP_37._p, block = $iter || nil;

      args = $slice.call(arguments, 1);
      TMP_37._p = null;
      args = ($a = ($b = args).$collect, $a._p = (TMP_38 = function(x){var self = TMP_38._s || this, $a, $b, TMP_39;
if (x == null) x = nil;
      if ((($a = x['$instance_of?']((($b = $scope.Array) == null ? $opal.cm('Array') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
          return ($a = ($b = x).$collect, $a._p = (TMP_39 = function(y){var self = TMP_39._s || this;
if (y == null) y = nil;
          return y.$to_s()}, TMP_39._s = self, TMP_39), $a).call($b).$join(" ")
          } else {
          return x
        }}, TMP_38._s = self, TMP_38), $a).call($b).$join("-");
      return self.$puts("" + (name) + " " + (args));
    };

    return (def.$initialize = TMP_40 = function() {
      var $a, $b, self = this, $iter = TMP_40._p, block = $iter || nil;
